...
-type repeater(HPS) :: any() | {gleam_phantom, HPS}.
...
-spec call(integer(), HPT, fun((HPT, integer()) -> HPT)) -> repeater(HPT).
...
-spec set_function(repeater(HPX), fun((HPX, integer()) -> HPX)) -> nil.
...
-spec update_state(repeater(HQB), fun((HQB) -> HQB)) -> nil.
...
-spec set_state(repeater(HPZ), HPZ) -> nil.
