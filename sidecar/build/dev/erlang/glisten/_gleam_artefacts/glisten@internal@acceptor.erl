...
-type pool(YSM, YSN) :: {pool,
        fun((YSM, glisten@internal@handler:loop_message(YSN), glisten@internal@handler:connection(YSN)) -> glisten@internal@handler:next(YSM, glisten@internal@handler:loop_message(YSN))),
        integer(),
        fun((glisten@internal@handler:connection(YSN)) -> {YSM,
            gleam@option:option(gleam@erlang@process:selector(YSN))}),
        gleam@option:option(fun((YSM) -> nil)),
        glisten@transport:transport()}.
