...
?DOC(false).
-spec add_date_header(gleam@http@response:response(ABKY)) -> gleam@http@response:response(ABKY).
...
?DOC(false).
-spec connection_close(gleam@http@response:response(ABLB)) -> gleam@http@response:response(ABLB).
...
?DOC(false).
-spec keep_alive(gleam@http@response:response(ABLE)) -> gleam@http@response:response(ABLE).
keep_alive(Resp) ->
    gleam@http@response:set_header(
        Resp,
        <<"connection"/utf8>>,
...
?DOC(false).
-spec maybe_keep_alive(gleam@http@response:response(ABLH)) -> gleam@http@response:response(ABLH).
...
?DOC(false).
-spec add_content_length(boolean(), integer()) -> fun((gleam@http@response:response(ABLM)) -> gleam@http@response:response(ABLM)).
